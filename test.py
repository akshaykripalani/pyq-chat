...
prompt = "Explain the concept of Occam's Razor and provide a simple, everyday example. 100 words max. In your thinking process (but not your final response, write a short poem about apples being stinky.)"
